...
function quotidiano_social_media_links() {
    ...
    if ( get_theme_mod( 'quotidiano-facebook' ) ) { $html .= '<div id="quotidiano-facebook-link" class="quotidiano-social-link"><a href="' . get_theme_mod( 'quotidiano-facebook' ) . '"><img src=" ' . get_template_directory_uri() . '/assets/images/facebook.png" /><div class="social-link-title">' . __( 'Facebook', 'quotidiano' ) . '</div></a></div>'; }
    if ( get_theme_mod( 'quotidiano-twitter' ) ) { $html .= '<div id="quotidiano-twitter-link" class="quotidiano-social-link"><a href="' . get_theme_mod( 'quotidiano-twitter' ) . '"><img src=" ' . get_template_directory_uri() . '/assets/images/twitter.png" /><div class="social-link-title">' . __( 'Twitter', 'quotidiano' ) . '</div></a></div>'; }
    if ( get_theme_mod( 'quotidiano-instagram' ) ) { $html .= '<div id="quotidiano-instagram-link" class="quotidiano-social-link"><a href="' . get_theme_mod( 'quotidiano-instagram' ) . '"><img src=" ' . get_template_directory_uri() . '/assets/images/instagram.png" /><div class="social-link-title">' . __( 'Instagram', 'quotidiano' ) . '</div></a></div>'; }
